...
import {
	...
	MAX_POST_FILE_SIZE_MB,
	MAX_PROFILE_FILE_SIZE_MB,
} from '~src/consts/image';

/**
 * Profile Image 스키마
 * @property size: MAX_PROFILE_FILE_SIZE_MB
 * @property type: ACCEPTED_IMAGE_TYPES
 */
export const schemaProfileImage = z
	.instanceof(File)
	.refine(file => file.size <= MAX_PROFILE_FILE_SIZE_MB, {
		message: `파일 크기는 최대 ${MAX_PROFILE_FILE_SIZE_MB / 1000000}MB까지 허용`,
	})
 ...
 * @property type: ACCEPTED_IMAGE_TYPES
 */
export const schemaPostImage = z
	.instanceof(File)
